...
class FAQArray1Page extends StatefulWidget {
  const FAQArray1Page({Key? key}) : super(key: key);

  @override
  State<FAQArray1Page> createState() => _FAQArray1PageState();
}

class _FAQArray1PageState extends State<FAQArray1Page> {

  int checkingvalue = -1;
  List<FAQModel> faqModel = const<FAQModel>[
  ...
  void initState() {
    ...
    super.initState();
    isTitleClicked = List<bool>.filled(this.faqModel.length, false);
  }
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: (faqModel == null)? 0 : faqModel.length,
