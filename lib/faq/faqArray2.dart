...
class FAQArray2Page extends StatefulWidget {
  const FAQArray2Page({Key? key}) : super(key: key);

  @override
  State<FAQArray2Page> createState() => _FAQArray2PageState();
}

class _FAQArray2PageState extends State<FAQArray2Page> {

  int checkingvalue = -1;
  List<FAQModel> faqModel2 = const<FAQModel>[
  ...
  void initState() {
    ...
    super.initState();
    isTitleClicked = List<bool>.filled(this.faqModel2.length, false);
  }
  @override
  Widget build(BuildContext context) {
    return Container(
        ...
        child: ListView.builder(
          ...
          itemCount: (faqModel2 == null)? 0 : faqModel2.length,
