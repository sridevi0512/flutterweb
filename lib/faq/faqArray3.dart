...
class FAQArray3Page extends StatefulWidget {
  const FAQArray3Page({Key? key}) : super(key: key);

  @override
  State<FAQArray3Page> createState() => _FAQArray3PageState();
}

class _FAQArray3PageState extends State<FAQArray3Page> {

  int checkingvalue = -1;
  List<FAQModel> faqModel3 = const<FAQModel>[
  ...
  void initState() {
    ...
    super.initState();
    isTitleClicked = List<bool>.filled(this.faqModel3.length, false);
  }
  @override
  Widget build(BuildContext context) {
    return Container(
        ...
        child: ListView.builder(
          ...
          itemCount: (faqModel3 == null)? 0 : faqModel3.length,
