...
class FAQArray4Page extends StatefulWidget {
  const FAQArray4Page({Key? key}) : super(key: key);

  @override
  State<FAQArray4Page> createState() => _FAQArray4PageState();
}

class _FAQArray4PageState extends State<FAQArray4Page> {

  int checkingvalue = -1;
  List<FAQModel> faqModel4 = const<FAQModel>[
  ...
  void initState() {
    ...
    super.initState();
    isTitleClicked = List<bool>.filled(this.faqModel4.length, false);
  }
  @override
  Widget build(BuildContext context) {
    return Container(
        ...
        child: ListView.builder(
          ...
          itemCount: (faqModel4 == null)? 0 : faqModel4.length,
